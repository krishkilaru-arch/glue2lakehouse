...
def main():
    ...
    try:
        ...
        with StageTimer(metrics, "read_applications"):
            ...
            apps_frame = glueContext.create_dynamic_frame.from_catalog(
                database=args['source_database'],
                table_name="loan_applications",
                transformation_ctx="applications",
                push_down_predicate=f"processing_date = '{args['processing_date']}' AND status = 'PENDING'"
            )
        ...
        with StageTimer(metrics, "read_credit_data"):
            ...
            credit_frame = glueContext.create_dynamic_frame.from_catalog(
                database=args['source_database'],
                table_name="credit_bureau_reports",
                transformation_ctx="credit_bureau"
            )
        ...
        with StageTimer(metrics, "read_customer_history"):
            ...
            history_frame = glueContext.create_dynamic_frame.from_catalog(
                database=args['source_database'],
                table_name="customer_payment_history",
                transformation_ctx="payment_history"
            )
            ...
            history_frame = DynamicFrame.fromDF(customer_metrics, glueContext, "customer_metrics")
        ...
        with StageTimer(metrics, "join_data"):
            ...
            apps_df = apps_frame.toDF()
            credit_df = credit_frame.toDF()
            history_df = history_frame.toDF()
        ...
        with StageTimer(metrics, "write_results"):
            ...
            scored_frame = DynamicFrame.fromDF(scored_df, glueContext, "scored")
            ...
            glueContext.write_dynamic_frame.from_options(
                ...
                transformation_ctx="write_decisions"
            )
