...
LOCATION 's3://apex-financial-datalake-raw/loan_applications/'
TBLPROPERTIES (
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.parquet.serde.ParquetHiveSerDe'
STORED AS PARQUET
LOCATION 's3://apex-financial-datalake-raw/applicants/'
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.parquet.serde.ParquetHiveSerDe'
STORED AS PARQUET
LOCATION 's3://apex-financial-datalake-raw/credit_bureau_reports/'
TBLPROPERTIES ('classification' = 'parquet');
...
STORED AS TEXTFILE
LOCATION 's3://apex-financial-inbound/dealer_applications/'
TBLPROPERTIES (
    'classification' = 'json',
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.parquet.serde.ParquetHiveSerDe'
STORED AS PARQUET
LOCATION 's3://apex-financial-datalake-raw/payment_transactions/'
TBLPROPERTIES ('classification' = 'parquet');
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.parquet.serde.ParquetHiveSerDe'
STORED AS PARQUET
LOCATION 's3://apex-financial-datalake-raw/vehicle_inventory/'
TBLPROPERTIES ('classification' = 'parquet');
