...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/loan_applications/'
TBLPROPERTIES (
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/credit_bureau_reports/'
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/active_loans/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/customer_payment_history/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/payment_transactions/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-curated/dealers/'
TBLPROPERTIES ('classification' = 'parquet');
