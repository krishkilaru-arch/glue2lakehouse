...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/credit_decisions/'
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/portfolio_cube/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/portfolio_daily_snapshot/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/vintage_analysis/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/concentration_risk/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/dealer_performance/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/regulatory_compliance/'
TBLPROPERTIES ('classification' = 'parquet');
...
USING DELTA
LOCATION '/Volumes/production/external/apex-financial-datalake-analytics/executive_dashboard/'
TBLPROPERTIES ('classification' = 'parquet');
